...
return [
    ...
    'timestamp' => 1582163918,
    'checksum' => 'd502b0e8220edcc26790536202e875dd',
    'files' => [
        ...
        'user/plugins' => [
            ...
            'plugins/tinypng' => [
                'file' => 'user/plugins/tinypng/blueprints.yaml',
                'modified' => 1581049873
            ],
            'plugins/problems' => [
    ...
    'data' => [
        'items' => [
            ...
            'plugins.tinypng.enabled' => [
                ...
                'name' => 'plugins.tinypng.enabled',
                'validation' => 'strict'
            ],
            'plugins.tinypng.api_key' => [
                'type' => 'text',
                'label' => 'API Key',
                'name' => 'plugins.tinypng.api_key',
                'validation' => 'strict'
            ],
            'plugins.problems' => [
                'type' => '_root',
        ...
        'nested' => [
            ...
            'plugins' => [
                ...
                'tinypng' => [
                    'enabled' => 'plugins.tinypng.enabled',
                    'api_key' => 'plugins.tinypng.api_key'
                ],
                'problems' => [
