...
return [
    ...
    'timestamp' => 1582163847,
    'checksum' => 'ca2a5c96c3e18fd8cb334f207ff58a79',
    'files' => [
        'user/config' => [
            'backups' => [
            ...
            'themes/avoy' => [
                'file' => 'user/config/themes/avoy.yaml',
                'modified' => 1582067964
            ],
            'themes/bootstrap' => [
        ...
        'user/plugins' => [
            ...
            'plugins/tinypng' => [
                'file' => 'user/plugins/tinypng/tinypng.yaml',
                'modified' => 1581049873
            ],
            'plugins/problems' => [
    ...
    'data' => [
        'plugins' => [
            ...
            'tinypng' => [
                'enabled' => true,
                'api_key' => 'Your tinypng.com API key'
            ],
            'problems' => [
                'enabled' => true,
                'built_in_css' => true
